...
async function getEbayToken() {
  ...
  requestBody.append('scope', 'https://api.ebay.com/oauth/api_scope');
  ...
  if (!response.ok) {
    ...
    throw new Error(`eBay Rejected Token Request. Details: ${errorDetails}`);
  }
...
async function fetchListings() {
  ...
  if (!response.ok) {
    const errorDetails = await response.text();
    throw new Error(`Inventory Request Rejected. Details: ${errorDetails}`);
  }
